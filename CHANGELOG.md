...
## Version 3.0.7 (January 26th, 2026)

### Refactoring

- **general:** disable http api request, not intended to be enabled during preview

## Version 3.0.6 (January 26th, 2026)

### Refactoring

- **general:** reset 'preview' version expiry time as 30+ days has passed since previous release
...
- **grouping:** grouped node labels are created twice or more if the grouping level node label is not sorted alphabetically by task name in the source taskfile
...
- **commands** clicking on a task to open the src file does not scroll to the task name in package.json files that are not located in the root project workspace folder.
...
- add 'open terminal' button for running tasks - closes [#39](https://github.com/spmeesseman/vscode-taskexplorer/issues/39) ([3b4be06](https://github.com/spmeesseman/vscode-taskexplorer/commit/3b4be06))
